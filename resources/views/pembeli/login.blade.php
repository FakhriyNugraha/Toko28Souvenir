    ...
    <div class="w-full max-w-4xl bg-white shadow-2xl rounded-2xl overflow-hidden flex flex-col md:flex-row">
        ...
        <div class="w-full md:w-1/2 flex items-center justify-center p-8">
            <div class="w-full max-w-md">
                <h2 class="text-2xl font-bold text-pink-700 mb-6 text-center">Masuk ke Akun Pembeli</h2>
                
                <form action="/pembeli/masuk" method="POST" class="space-y-6">
                    @csrf
                ...
                <div class="mt-4 text-sm text-center">
                    <p>
                        Belum punya akun?
                        <a href="{{ route('pembeli.daftar') }}" class="text-pink-600 hover:underline font-medium">Daftar Sekarang</a>
                    </p>
                    <p class="mt-2">
                        <a href="{{ url('/pembeli/lupa-katasandi') }}" class="text-pink-500 hover:underline">Lupa Kata Sandi?</a>
                    </p>
                </div>
            </div>
        </div>
